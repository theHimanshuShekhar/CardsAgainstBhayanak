...
function App() {
  ...
  if (screen === "join")             scene = <JoinScreen   go={go} draft={draft} setDraft={setDraft} roomFull={t.roomFull} />;
  if (screen === "lobby")            scene = <LobbyScreen  go={go} draft={draft} isHost={true}  roomFull={t.roomFull} />;
  if (screen === "lobby-spectator")  scene = <LobbyScreen  go={go} draft={draft} isHost={false} asSpectator={true} roomFull={t.roomFull} />;
  if (screen === "game")             scene = <GameScreen   go={go} draft={draft} role={t.role} setRole={(r) => setTweak('role', r)} />;
