...
window.PROMPT_CARDS = [
  ...
  { text: "My ideal Sunday: wake up to __________, spend the afternoon with __________, and end it all with __________.", blanks: 3 },
  { text: "My therapist told me to stop blaming __________ for everything. I'm not going to.", blanks: 1 },
  ...
  { text: "The new self-help bestseller is titled \"How to __________ Without __________.\"", blanks: 2 },
...
window.CARD_PACKS = [
  { id: "core",    name: "Core Pack",        count: 460, desc: "The essentials. Tame enough for most rooms.", on: true,  locked: true  },
  { id: "office",  name: "Office Hours",     count: 120, desc: "For the Slack-poisoned and meeting-pilled.", on: true,  locked: false },
  { id: "desi",    name: "Bhayanak Desi",    count: 180, desc: "Auntie jokes, joint family chaos, IST suffering.", on: true,  locked: false },
  { id: "online",  name: "Extremely Online", count: 95,  desc: "Memes, discourse, and posting-induced injuries.", on: false, locked: false },
  { id: "spicy",   name: "Spicy (18+)",      count: 210, desc: "PG-13 turned up. Lock the door.", on: false, locked: false },
  { id: "holidays",name: "Festive Edition",  count: 75,  desc: "Diwali, Christmas, and forced family gatherings.", on: false, locked: false },
];

window.HOUSE_RULES = [
  { id: "rebooting",  name: "Rebooting the Universe", desc: "Trade a point to redraw your entire hand." },
