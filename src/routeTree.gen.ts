...
const ApiGamesCodeRoundRoute = ApiGamesCodeRoundRouteImport.update({
  id: '/api/games/$code/round',
...
const ApiGamesCodeHandRoute = ApiGamesCodeHandRouteImport.update({
  id: '/api/games/$code/hand',
